...
(103,'OMKAR CHIKANE','snehatonde@gmail.com','BANGLORE',5),
(104,'RIYA SURMA','riyasurma@gmail.com','PUNE',1),
(105,'PRASAD SURVE','nikitawaghmare@gmail.com','MUMBAI',3);
...
FROM students
JOIN enrollments
ON students_id =enrollments.students_id;

-- 72 Display all courses and their trainers.
SELECT * 
FROM courses
JOIN trainers
ON courses.trainer_id= trainers.trainers_id
...
SELECT course_id, AVG(amount_paid)
FROM enrollments
GROUP BY course_id;
